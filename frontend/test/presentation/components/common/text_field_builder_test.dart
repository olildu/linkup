...
import 'package:linkup/shared_ui/components/common/text_field_builder.dart';
import '../../../test_helper.dart';

void main() {
  group('TextFieldBuilder', () {
    testWidgets('renders with initial value and calls onChanged', (
      tester,
    ) async {
      String? changedValue;
    ...
    testWidgets('respects maxLines property', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(TextFieldBuilder(hintText: 'Multiline', maxLines: 7)),
      );
