...
import 'package:linkup/features/onboarding/presentation/components/progress_bar_component.dart';
...
void main() {
  group('ProgressBarComponent Widget Tests', () {
    ...
    testWidgets('Renders all bars correctly in initial state', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Correctly animates colors when currentIndex is changed', (
      WidgetTester tester,
    ) async {
