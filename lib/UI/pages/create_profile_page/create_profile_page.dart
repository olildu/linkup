...
import 'package:linkup/UI/elements/create_profile_elements/elements.dart';
              ...
              return Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: (indexTracker.contains(index))? const Color.fromARGB(255, 0, 173, 170) : Colors.grey, // Change color or style as needed
                    borderRadius: BorderRadius.circular(20)
                  ),
                ),
              );
