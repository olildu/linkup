...
import 'package:linkup/features/messaging/presentation/components/minor_event_widgets.dart';
...
void main() {
  const mockImageMetaData = {
    'url': 'http://img.jpg',
    'blurhash':
        r"|HF}[*IU1j-p$gNHVsofWXEMofxCNGt6s.WYazayEgjZ$%WVNGofa}f6kCIrof$$ayNHayoyayof-oR*Rjs:Nbj]xZWVaeNdofn~WBoLWBofoLWVxtayNHa}xZj[Rkj[WV%1fkIpoet6WBs.j[R*xaayRka#ofoLR*fkjs",
  };

  testWidgets('buildTypingIndicator renders profile image and text', (
    tester,
  ) async {
