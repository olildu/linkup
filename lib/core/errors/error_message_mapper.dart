...
const List<MapEntry<String, String>> _detailRules = [
  ...
  MapEntry(
    'Invalid image file',
    "That image couldn't be processed. Please try another.",
  ),
  MapEntry(
    'Unable to fetch image from URL',
    "We couldn't load that image. Please try again.",
  ),
  ...
  MapEntry(
    'User not in match queue',
    "You're not in the matching queue right now.",
  ),
  MapEntry(
