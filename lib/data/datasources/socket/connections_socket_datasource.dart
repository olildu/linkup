...
class ConnectionsSocketDatasource extends BaseSocketService {
  static final ConnectionsSocketDatasource _instance = ConnectionsSocketDatasource._();

  factory ConnectionsSocketDatasource.instance() => _instance;

  ConnectionsSocketDatasource._()
      : super(uri: Uri.parse('$WS_BASE_URL/connections'), logTag: 'ConnectionsSocketDatasource');
