...
from app.features.connections.models.connection_user_model import ConnectionChatModel, ConnectionMatchModel
from app.features.connections.connections_utilities import get_last_message_timestamp

connections_router = APIRouter(prefix="/matches")

@connections_router.get("/get-connections")
@handle_db_errors
