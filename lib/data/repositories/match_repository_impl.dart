...
class MatchRepositoryImpl implements MatchRepository {
  ...
  @override
  Future<({List<MatchesConnectionEntity> matches, List<ChatConnectionEntity> chats})>
      getConnections() async {
    final result = await _matchDatasource.getConnections();
    return (
      matches: result.matches
          .map((m) => MatchesConnectionEntity(
                id: m.id,
                username: m.username,
                profilePictureMetaData: m.profilePictureMetaData,
              ))
  ...
  ChatConnectionEntity _chatToEntity(ChatsConnectionModel m) => ChatConnectionEntity(
        id: m.id,
        username: m.username,
        profilePictureMetaData: m.profilePictureMetaData,
  ...
  ChatsConnectionModel _entityToChat(ChatConnectionEntity e) => ChatsConnectionModel(
        id: e.id,
        username: e.username,
